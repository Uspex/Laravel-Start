        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between g-3">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ __('Категории') }}</h3>
                </div>
                <div class="nk-block-head-content">
                    <div class="nk-block-head-content">
                        <a href="{{ route('admin.category.create') }}" class="btn btn-primary"><em class="icon ni ni-plus"></em><span>{{ __('Добавить категорию') }}</span></a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-inner p-0">
                            <div class="nk-tb-list">
                                <div class="nk-tb-item nk-tb-head">
                                    ...
                                    <div class="nk-tb-col text-center"><span>{{ __('Кол шаблонов') }}</span></div>
                                ...
                                @foreach($paginator as $item)
                                    <div class="nk-tb-item">
                                        <div class="nk-tb-col tb-col-sm">
                                            <a href="{{ route('admin.category.edit', $item->id) }}"><span>{{ $item->name }}</span></a>
                                        </div>
                                        <div class="nk-tb-col">
                                            <span>{{ $item->slug }}</span>
                                        </div>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="{{ route('admin.category.edit', $item->id) }}"><em class="icon ni ni-edit"></em><span>{{ __('Редактировать') }}</span></a></li>
                                                                <li>

...
@section('page_title', __('Редактирование категории'))
@section('page_excerpt', __('Редактирование категории'))
        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between g-3">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ __('Редактирование категории') }} </h3>
                </div>
                <div class="nk-block-head-content">
                    <a href="{{ route('admin.category.index') }}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>{{ __('Назад') }}</span></a>
                </div>
            </div>
        </div><!-- .nk-block-head -->
        <div class="nk-block">

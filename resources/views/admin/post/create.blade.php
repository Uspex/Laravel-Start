...
@section('page_title', __('Создание поста'))
@section('page_excerpt', __('Создание поста'))
        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between g-3">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ __('Создание поста') }} </h3>
                </div>
                <div class="nk-block-head-content">
                                            ...
                                            <div class="row g-4">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="seo_title" value="{{ old('seo_title') }}"
                                                               id="seo_title"
                                                               type="text"
                                                               class="form-control">
                                                    </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="seo_keywords" value="{{ old('seo_keywords') }}"
                                                               id="seo_keywords"
                                                               type="text"
                                                               class="form-control">
                                                    </div>

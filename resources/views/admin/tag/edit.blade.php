...
@section('page_title', __('Редактирование тега'))
@section('page_excerpt', __('Редактирование тега'))
        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between g-3">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">{{ __('Редактирование тега') }} </h3>
                </div>
                <div class="nk-block-head-content">
            ...
            <div class="card card-bordered">
                <div class="card-aside-wrap">
                    <div class="card-content">
                        <form method="POST" action="{{ route('admin.tag.update', $item->id) }}" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf

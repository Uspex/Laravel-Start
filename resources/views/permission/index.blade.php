                        ...
                        <div class="card-inner p-0">
                            <table class="table table-tranx">
                                ...
                                <tr class="tb-tnx-head">
                                    <th class="tb-tnx-id"><span class="">{{ __('slug') }}</span></th>
                                    <th class="tb-tnx-info"><span>{{ __('Название') }}</span></th>
                                    <th class="tb-tnx-info"><span>{{ __('группа') }}</span></th>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-sm">
                                                    <ul class="link-list-plain">
                                                        <li><a href="{{ route('permission.show', $item->id) }}">{{ __('Просмотреть') }}</a></li>
                                                        <li><a href="{{ route('permission.edit', $item->id) }}">{{ __('Редактировать') }}</a></li>
                                                        <li>
